...
An end-to-end, real-time bi-directional voice assistant built on the **Waveshare ESP32-S3-AUDIO Board** powered by **Google Gemini Live API** and a **Custom Clinical Patient Persona (`Samarth`)**.
